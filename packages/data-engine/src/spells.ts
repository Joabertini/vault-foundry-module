...
export const spellCatalog: SpellCatalogEntry[] = [
  ...
  spell({ id: "eldritch-blast", label: "Eldritch Blast", level: 0, classes: ["warlock"], aliases: ["estallido sobrenatural"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 120, units: "ft", label: "120 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Descarga arcana que escala en numero de rayos." }),
  spell({ id: "fire-bolt", label: "Fire Bolt", level: 0, classes: ["artificer", "sorcerer", "wizard"], aliases: ["rayo de fuego"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 120, units: "ft", label: "120 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Proyectil de fuego de largo alcance." }),
  ...
  spell({ label: "Mage Hand", level: 0, classes: ["artificer", "bard", "sorcerer", "warlock", "wizard"], aliases: ["mano de mago"], school: "con", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 30, units: "ft", label: "30 feet" }, duration: { value: "1", units: "minute", label: "1 minute" }, components: ["vocal", "somatic"], summary: "Una mano espectral manipula objetos a distancia." }),
  ...
  spell({ label: "Prestidigitation", level: 0, classes: ["artificer", "bard", "sorcerer", "warlock", "wizard"], aliases: ["prestidigitacion"], school: "trs", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 10, units: "ft", label: "10 feet" }, duration: { value: "1", units: "hour", label: "Up to 1 hour" }, components: ["vocal", "somatic"], summary: "Pequenos efectos magicos utilitarios." }),
  ...
  spell({ id: "ray-of-frost", label: "Ray of Frost", level: 0, classes: ["artificer", "sorcerer", "wizard"], aliases: ["rayo de escarcha"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 60, units: "ft", label: "60 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Rayo helado que reduce velocidad." }),
  spell({ label: "Resistance", level: 0, classes: ["artificer", "cleric", "druid"], aliases: ["resistencia"], school: "abj", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: null, units: "touch", label: "Touch" }, duration: { value: "1", units: "minute", label: "Up to 1 minute" }, components: ["vocal", "somatic", "material"], summary: "El objetivo suma 1d4 a una salvacion." }),
  spell({ label: "Sacred Flame", level: 0, classes: ["cleric"], aliases: ["llama sagrada"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 60, units: "ft", label: "60 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Llamarada radiante contra un objetivo." }),
  ...
  spell({ label: "Cure Wounds", level: 1, classes: ["artificer", "bard", "cleric", "druid", "paladin", "ranger"], aliases: ["curar heridas"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: null, units: "touch", label: "Touch" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Recuperacion directa de puntos de golpe." }),
  ...
  spell({ label: "Hex", level: 1, classes: ["warlock"], aliases: ["maldicion"], school: "enc", castingTime: { type: "bonus", value: 1, label: "1 bonus action" }, range: { value: 90, units: "ft", label: "90 feet" }, duration: { value: "1", units: "hour", label: "Up to 1 hour" }, components: ["vocal", "somatic", "material"], summary: "Maldices al objetivo y le impones desventaja." }),
  ...
  spell({ label: "Magic Missile", level: 1, classes: ["sorcerer", "wizard"], aliases: ["misil magico"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 120, units: "ft", label: "120 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Dardos automaticos de energia." }),
  ...
  spell({ label: "Shield", level: 1, classes: ["artificer", "sorcerer", "wizard"], aliases: ["escudo"], school: "abj", castingTime: { type: "reaction", value: 1, label: "1 reaction" }, range: { value: null, units: "self", label: "Self" }, duration: { value: "1", units: "round", label: "Until start of your next turn" }, components: ["vocal", "somatic"], summary: "Barrera invisible de +5 AC." }),
  ...
  spell({ label: "Hold Person", level: 2, classes: ["bard", "cleric", "druid", "sorcerer", "warlock", "wizard"], aliases: ["inmovilizar persona"], school: "enc", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 60, units: "ft", label: "60 feet" }, duration: { value: "1", units: "minute", label: "Up to 1 minute" }, components: ["vocal", "somatic", "material"], summary: "Paralizas a un humanoide." }),
  ...
  spell({ label: "Mirror Image", level: 2, classes: ["bard", "sorcerer", "wizard"], aliases: ["imagen multiple"], school: "ill", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: null, units: "self", label: "Self" }, duration: { value: "1", units: "minute", label: "1 minute" }, components: ["vocal", "somatic"], summary: "Tres duplicados ilusorios te protegen." }),
  spell({ label: "Misty Step", level: 2, classes: ["sorcerer", "warlock", "wizard"], aliases: ["paso brumoso"], school: "con", castingTime: { type: "bonus", value: 1, label: "1 bonus action" }, range: { value: null, units: "self", label: "Self" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal"], summary: "Teletransporte corto como accion bonus." }),
  ...
  spell({ label: "Scorching Ray", level: 2, classes: ["sorcerer", "wizard"], aliases: ["rayo abrasador"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 120, units: "ft", label: "120 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic"], summary: "Tres rayos de fuego dirigibles." }),
  ...
  spell({ label: "Counterspell", level: 3, classes: ["sorcerer", "warlock", "wizard"], aliases: ["contraconjuro"], school: "abj", castingTime: { type: "reaction", value: 1, label: "1 reaction" }, range: { value: 60, units: "ft", label: "60 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["somatic"], summary: "Interrumpes el conjuro de otra criatura." }),
  ...
  spell({ label: "Fireball", level: 3, classes: ["sorcerer", "wizard"], aliases: ["bola de fuego"], school: "evo", castingTime: { type: "action", value: 1, label: "1 action" }, range: { value: 150, units: "ft", label: "150 feet" }, duration: { value: "", units: "inst", label: "Instantaneous" }, components: ["vocal", "somatic", "material"], summary: "Explosion de fuego en gran area." }),
