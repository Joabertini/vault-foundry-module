...
- next work should focus on deleting or collapsing legacy-only builder logic that is now shadowed by `canonicalFoundryPreview`, because the bridge is carrying more of the final `system` shape already;
