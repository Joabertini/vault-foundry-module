...
- next work should focus on converging `vault-app` / `character-builder` onto the shared exporter path, because the operator-facing workflow has already improved materially;
