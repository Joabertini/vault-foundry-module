...
- shared domain now owns cantrip limits, spell-selection modes, spell-selection labels, max-level derivation, selection sanitizing, and spell-selection profiles by class and level;
