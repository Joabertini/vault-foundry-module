...
| `pact-warlock-5` | ok | 0 | 1 | `docs/foundry-validation-fixtures/pact-warlock-5.json` |
...
| `warning-only` | ok | 0 | 3 | `docs/foundry-validation-fixtures/warning-only.json` |
| `blocked-invalid-class` | blocked | 1 | 1 | `docs/foundry-validation-fixtures/blocked-invalid-class.json` |
