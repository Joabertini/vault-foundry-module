...
- variables soportadas: `BERTINIS_5E_UPSTREAM_CLASSES_PATH`, `BERTINIS_5E_UPSTREAM_RACES_PATH`, `BERTINIS_5E_UPSTREAM_BACKGROUNDS_PATH`, `BERTINIS_5E_UPSTREAM_FEATS_PATH` y `BERTINIS_5E_UPSTREAM_EQUIPMENT_PATH`
